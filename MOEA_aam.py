...
if __name__ == "__main__":
        ...
        with LibraryManager() as manager:
            ...
            for objectives in objective_sets:
                ...
                # Save
                csv_path = os.path.join(save_path, f"{run_id}__{obj_name}_300.csv")
                pop_path = os.path.join(save_path, f"{run_id}__{obj_name}_300_populations.pkl")
